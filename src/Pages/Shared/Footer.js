    ...
    return (
        <div>
            <footer
                ...
                className="bg-info text-white lg:grid lg:grid-cols-5"
            >
                ...
                <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
                    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
                        <div className='text-center'>
                            <p className="font-medium">
                                <span className="text-xs uppercase tracking-widest"> Call For Hire </span>
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div className=' text-center'>
                                ...
                                <nav
                                    ...
                                    className="mt-4 flex flex-col space-y-2 text-sm text-base-100"
                                >
                                    ...
                                    <Link className="hover:opacity-75" href=""> Forums </Link>
                                </nav>
                            </div>
                    ...
                    <div className="mt-12 border-t border-base-content pt-12">
                        <div
                            className="text-sm text-base-200 sm:flex sm:items-center sm:justify-between"
                        >
